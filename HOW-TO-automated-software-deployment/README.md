...
![deploy-firefox-criteria](tutorials/HOW-TO-automated-software-deployment/resources/deploy-firefox-criteria.png)

### remove_Firefox

Create a Smart Computer Group called `remove_Firefox` with the following criteria now.

![remove-firefox-criteria](tutorials/HOW-TO-automated-software-deployment/resources/remove-firefox-criteria.png)
